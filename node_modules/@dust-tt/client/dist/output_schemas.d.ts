...
export declare const NotificationContentCreationFileContentSchema: z.ZodObject<{
    type: z.ZodLiteral<"content_creation_file">;
    fileId: z.ZodString;
    mimeType: z.ZodString;
    title: z.ZodString;
...
type ContentCreationFileContentOutput = z.infer<typeof NotificationContentCreationFileContentSchema>;
export declare function isContentCreationFileContentOutput(output: ProgressNotificationOutput): output is ContentCreationFileContentOutput;
